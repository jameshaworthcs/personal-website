              ...
              <div className="relative border-l-2 border-primary/30 ml-6 md:ml-0 md:mx-auto space-y-10 pl-8">
                  ...
                  <div className="bg-card border rounded-lg p-6 shadow-sm hover:shadow-md transition-all">
                    <div className="flex flex-col md:flex-row md:items-center justify-between mb-2">
                      <h3 className="text-xl font-bold">
                        Cyber Security and IT Engineer
                      </h3>
                      <div className="flex items-center gap-2">
                        <span className="text-sm font-medium text-muted-foreground">
                          RosettaPath
                ...
                <div className="relative">
                  ...
                  <div className="bg-card border rounded-lg p-6 shadow-sm hover:shadow-md transition-all">
                    ...
                    <ul className="text-muted-foreground mb-4 list-disc pl-5 space-y-1">
                      <li>
                        Collaborated with a team of software developers to build
                        full stack applications using React and Next.js.
                      </li>
                      <li>
                        Integrated cloud databases to support scalable and
                        efficient web applications within the team.
                      </li>
                      <li>
                        Enhanced website usability and performance, ensuring
                        seamless access and responsiveness across all devices.
                      </li>
                    </ul>
                    <div className="flex gap-2 flex-wrap">
                      <span className="px-2 py-1 rounded-full text-xs bg-primary/10 text-primary">
                ...
                <div className="relative">
                  ...
                  <div className="bg-card border rounded-lg p-6 shadow-sm hover:shadow-md transition-all">
                    ...
                    <ul className="text-muted-foreground mb-4 list-disc pl-5 space-y-1">
                      <li>
                        Developed and scaled Verified Handles, using AI and
                        Python to build a database of 155,000+ key figures and
                        organizations.
                      </li>
                      <li>
                        Drove data analysis improvements, boosting match
                        accuracy by 25% for better brand-influencer connections.
                      </li>
                      <li>
                        Utilized proficiency in gCloud and AWS to optimize cloud
                  ...
                  <div className="bg-card border rounded-lg p-6 shadow-sm hover:shadow-md transition-all">
                    ...
                    <ul className="text-muted-foreground mb-4 list-disc pl-5 space-y-1">
                      <li>
                        ...
                        collaborating closely with a partner during a week-long
                        work experience.
                      </li>
                      <li>
                        Presented the innovative project to senior software
                        developers, demonstrating strong technical skills and
                        creativity.
                      </li>
                      <li>
                        Gained experience in a professional setting, taking part
                        in a poster session with industry leaders and
                ...
                <div className="relative">
                  ...
                  <div className="bg-card border rounded-lg p-6 shadow-sm hover:shadow-md transition-all">
                    ...
                    <ul className="text-muted-foreground mb-4 list-disc pl-5 space-y-1">
                      <li>
                        Advanced to Crew Trainer position, demonstrating
                        leadership and teamwork in a fast-paced environment over
                        3 years.
                      </li>
                      <li>
                        Resolved technical issues with card payments and
                        internal screens, keeping customers satisfied and
                        transaction times quick.
                      </li>
                    </ul>
                    <div className="flex gap-2 flex-wrap">
                      <span className="px-2 py-1 rounded-full text-xs bg-primary/10 text-primary">
                ...
                <div className="p-4 rounded-lg bg-card shadow-sm flex flex-col items-center">
                  <div className="h-12 w-12 flex items-center justify-center rounded-full bg-primary/10 text-primary mb-3">
                    ...
                    >
                      <path
                        fill="currentColor"
                        d="M480 32H32C14.3 32 0 46.3 0 64v384c0 17.7 14.3 32 32 32h448c17.7 0 32-14.3 32-32V64c0-17.7-14.3-32-32-32zM232 432H184V312h-40v-48h88v168zm56-168h-40v48h40v120h48V312h40v-48H288zm144 72c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32z"
                      />
                    </svg>
                  </div>
                ...
                <div className="p-4 rounded-lg bg-card shadow-sm flex flex-col items-center">
                  <div className="h-12 w-12 flex items-center justify-center rounded-full bg-primary/10 text-primary mb-3">
                    ...
                    >
                      <path
                        fill="currentColor"
                        d="M89.6 39.4c70.6-96.5 243.7-94.8 310.5 2.3 28.8 40.3 35.9 103.7 17.4 147.6-13.9 38.1-41.1 63.4-58.9 97.7-24.4 32.5-32.3 73.6-41.5 112.7-5.9 30.5-15 75-54.9 74.6-36.7-.4-47.3-42.6-53.8-72.4-10.9-41.6-21.6-85.3-47.5-119.8-20-28.8-47.8-50.5-62.2-83.8-22.1-43.7-31.2-110.7 10.9-158.9z"
                      />
                    </svg>
                  </div>
                ...
                <div className="p-4 rounded-lg bg-card shadow-sm flex flex-col items-center">
                  <div className="h-12 w-12 flex items-center justify-center rounded-full bg-primary/10 text-primary mb-3">
                    ...
                    >
                      <path
                        fill="currentColor"
                        d="M320 0c17.7 0 32 14.3 32 32V96H488c39.8 0 72 32.2 72 72V440c0 39.8-32.2 72-72 72H152c-39.8 0-72-32.2-72-72V168c0-39.8 32.2-72 72-72H288V32c0-17.7 14.3-32 32-32zM208 384c-8.8 0-16 7.2-16 16s7.2 16 16 16h32c8.8 0 16-7.2 16-16s-7.2-16-16-16H208zm96 0c-8.8 0-16 7.2-16 16s7.2 16 16 16h32c8.8 0 16-7.2 16-16s-7.2-16-16-16H304zm96 0c-8.8 0-16 7.2-16 16s7.2 16 16 16h32c8.8 0 16-7.2 16-16s-7.2-16-16-16H400zM264 256a40 40 0 1 0 -80 0 40 40 0 1 0 80 0zm152 40a40 40 0 1 0 0-80 40 40 0 1 0 0 80zM512 168v64H128V168c0-13.3 10.7-24 24-24H488c13.3 0 24 10.7 24 24z"
                      />
                    </svg>
                  </div>
