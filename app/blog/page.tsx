      ...
      <main className="flex-grow flex items-center justify-center p-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-10">
            ...
            Check back soon for insights on software development, tech trends, and more.
          </p>
          ...
          <div className="bg-muted/30 p-8 rounded-lg">
            ...
            <ul className="text-left space-y-3">
              <li className="flex items-start">
                <span className="inline-flex mr-2 mt-1 h-5 w-5 rounded-full bg-primary/20 text-primary items-center justify-center text-xs">✓</span>
              ...
              <li className="flex items-start">
                <span className="inline-flex mr-2 mt-1 h-5 w-5 rounded-full bg-primary/20 text-primary items-center justify-center text-xs">✓</span>
                <span>Thoughts on emerging technologies and industry trends</span>
              </li>
            </ul>
          </div>
